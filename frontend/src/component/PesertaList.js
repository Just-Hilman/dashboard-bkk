                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Daftar Peserta Seleksi</h1>
                            </div>
                                ...
                                <div class="col-xl-12 col-lg-7">
                                    <div class="card shadow mb-4">
                                        <div
                                            ...
                                            <h6 class="m-0 font-weight-bold text-primary">Peserta Seleksi</h6>
                                                    ...
                                                    <tbody>
                                                            {peserta.map((peserta, index) => (
                                                                <tr key={peserta.id}>
                                                                    ...
                                                                    <td>
                                                                        <Link to={`/edit/${peserta.id}`} class="btn btn-warning btn-ubah">Ubah</Link>
